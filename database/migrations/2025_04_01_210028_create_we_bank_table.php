...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('we_bank_stocks', function (Blueprint $table) {
            ...
            $table->string('adjust_unit_net_value', 8, 6)->nullable()->comment('当前净值 adjust_unit_net_value');
            $table->double('fundbeginyield', 5, 2)->nullable()->comment('成立以来年化收益率 ladder_rate.fundbeginyield');
            $table->double('monthyield', 5, 2)->nullable()->comment('近一个月年化收益率 ladder_rate.monthyield');
            $table->double('seasonyield', 5, 2)->nullable()->comment('近三个月年化收益率 ladder_rate.seasonyield');
